...
public class LogMessages {
    ...
    public static final String WORKSPACE_HAS_NO_REGISTRY_MODELS = "WORKSPACE_HAS_NO_REGISTRY_MODELS";
    public static final String REGISTRY_MODEL_NOT_FOUND = "REGISTRY_MODEL_NOT_FOUND";

    public static final String FAILED_REGISTER_EXPERIMENT = "FAILED_REGISTER_EXPERIMENT";
    public static final String FAILED_LOG_SYSTEM_DETAILS = "FAILED_LOG_SYSTEM_DETAILS";
